[![Documentation Status](https://readthedocs.org/projects/auto-remediation-of-non-compliant-junos-configuration/badge/?version=latest)](https://auto-remediation-of-non-compliant-junos-configuration.readthedocs.io/en/latest/?badge=latest)
...
[**The documentation is available on readthedocs**](https://auto-remediation-of-non-compliant-junos-configuration.readthedocs.io/en/latest/)
...
![RT-new-ticket.jpg](docs/RT-new-ticket.jpg)  

Then, SaltStack fixes this issue, and reports this new activity on the ticketing system.   
![RT-ticket-update.jpg](docs/RT-ticket-update.jpg)  
